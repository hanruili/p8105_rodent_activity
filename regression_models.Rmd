...
The p-value for the interaction term (p = 0.9736) indicates that the interaction between rental price and house price does not significantly affect the probability of rodent activity.
